...
typedef struct edge_device *Gpio_t;
typedef struct edge_device *Spi_t;
...
typedef struct SX127x_s
{
    ...
    //struct runqueue Q;
    struct schedule S;
    //struct runqueue_task_type Type[2];
    //struct runqueue_task Task[2];
}SX127x_t;

/*!
 * Hardware IO IRQ callback function definition
 */
typedef void ( DioIrqHandler )( struct uloop_fd *fd, unsigned int events );
