...
static void lorawan_thread_instance(struct thread *t);
...
static struct thread lorawan_thread;


/*!
 * Main application entry point.
 */
int lorawan_service( void )
{
    BoardInitMcu( );
    BoardInitPeriph( );
	...
	/* thread */
	memset(&lorawan_thread, 0, sizeof(lorawan_thread));
    lorawan_thread.thread = lorawan_thread_instance;
    thread_init(&lorawan_thread);
}
